                   ...
                   <!--Inicio menu lateral-->
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 tab-content">
                        ...
                        <div class="" id="admin-cadastros">
                             <h1 style="font-size: 27px;">Controle Finaceiro - Gerenciamento de Anunciantes Alterar</h1>
                             <div class="row borda-ver-admin">
                                  <form class="form-horizontal" method="POST" action="../controlers/atualizaAnuncio.php?id=9&idanuncio=<?php echo $id_anuncio ?>" enctype="multipart/form-data">
                                         ...
                                         <div class="col-sm-8 col-md-10" style="margin-top: 30px;">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                              <input type="text" class="form-control dinheiro" name="preco" value="<?php echo retornaDadosAnuncio(0) ?>" required>
                                            </div>
                                          </div>
                                          <div class="form-group">
                                          ...
                                          <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea type="text" maxlength="1000" name="descricao" class="form-control" rows="5" required> <?php echo retornaDadosAnuncio(2) ?> </textarea>
                                                </div>
                                          </div>
                                          <div style="margin-top: 50px;margin-bottom: 57px;padding-bottom: 5px;">
                                            ...
                                            <button type="submit" class="pull-right btn btn-cadastro botao-topo-cadastro" name="enviar">Alterar</button>
                                          </div>
                                         </div>
                                          <div class="col-sm-2 col-md-1"></div>
                                      </form>
