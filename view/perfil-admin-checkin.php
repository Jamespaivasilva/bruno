                   ...
                   <!--Inicio menu lateral-->
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 tab-content">
                        ...
                        <div class="" id="admin-cadastros">
                             <h1>Controle Finaceiro - Controle Check-in</h1>
                             <div class="row borda-ver-admin">
                                  <div class="margin-bottom-65px">
                                      <form class="form-group" method="POST" action="../controlers/buscaCheckin.php?id=9">
                                          <div class="col-md-5">
                                             <select name="atributo" class="form-control">
                                              ...
                                              <option value="nome_fantasia">Nome Estabelecimento</option>
                                             </select> 
                                          </div>
                                          <div class="col-md-5">
                                  ...
                                  <?php include "../controlers/retornaCheckinADM.php" ?>
                                  ...
                                  <div class="row" style="text-align: right;margin-bottom: 20px;">
                                      ...
                                      <div class="col-md-8">
                                          ...
                                          <div class="col-md-4">
                                              <a href="perfil-admin-checkin-visualizar.php?id=9&iduser=<?php echo $iduser ?>" class="link-opcoes-usuario">Visualizar</a>
                                          </div>
                                          <div class="col-md-4">
