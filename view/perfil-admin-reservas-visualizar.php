                   ...
                   <!--Inicio menu lateral-->
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 tab-content">
                        ...
                        <div class="" id="admin-cadastros">
                             <h1 style="font-size: 27px;">Controle Finaceiro - Controle de Reservas Visualizar</h1>
                             <div class="row borda-ver-admin">
                                  <form class="form-horizontal" method="POST" action="">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                              <input type="text" class="form-control" value=<?php echo dadosReserva(0) ?> name="nome" disabled>
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <label class="col-sm-3 control-label padding-top-7px">Data</label>
                                            <div class="col-sm-8">
                                              <input type="text" class="form-control" value=<?php echo dadosReserva(1) ?> name="data" disabled>
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <label class="col-sm-3 control-label padding-top-7px">Horário</label>
                                            <div class="col-sm-8">
                                              <input type="text" class="form-control" value=<?php echo dadosReserva(2) ?> name="horatio" disabled>
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <label class="col-sm-3 control-label padding-top-7px">Qtde. Pessoas</label>
                                            <div class="col-sm-8">
                                              <input type="text" class="form-control" value=<?php echo dadosReserva(4) ?> name="qtdePessoas" disabled>
                                            </div>
                                          </div>
