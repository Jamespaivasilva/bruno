                ...
                <div class="row">
                   ...
                   <!--Inicio menu lateral-->
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 tab-content">
                        <div class="row tab-pane active in fade" id="home">
                              <div class="text-center">
                                  <div class="col-md-4 margin-botton-50px">
                                      <a href="pessoa-jurica-admin-edita-perfil.php?id=<?php echo $id ?>" >
                                          <div class="div-admin">
                                              <img src="images/edita.png" style="height: 147px;"><br>
                                              <a href="pessoa-jurica-admin-edita-perfil.php"  class="link-opcoes-usuario"><strong>Editar Perfil</strong></a>
                                          </div>
                                      </a>
                                  </div>
                                  <div class="col-md-4 margin-botton-50px">
                                      <a href="reserva-visao-estabelecimento.php?id=<?php echo $id?>">
                                          <div class="div-admin">
                                              <img src="images/agenda.png" style="height: 147px;"><br>
                                              <a href="reserva-visao-estabelecimento.php"  aria-controls="editar-perfil" role="tab" data-toggle="tab"  class="link-opcoes-usuario"><strong>Solicitações de reservas</strong></a>
                                          </div>
                                      </a>                                      
                                  </div>
                                  <div class="col-md-4 margin-botton-50px">
                                      <a href="verifica_anuncio.php?id=<?php echo $id?>">
                                          <div class="div-admin">
                                              <img src="images/sucesso.png" style="height: 147px;"><br>
                                              <a href="verifica_anuncio.php?id=<?php echo $id?>" class="link-opcoes-usuario"><strong>Anúncios</strong></a>
                                          </div>
                                      </a>                                      
                                  </div>
                                  <div class="col-md-4 margin-botton-50px">
                                      <a href="pessoa-jurica-admin-relatorios.php?id=<?php echo $id?>">
                                          <div class="div-admin">
                                              <img src="images/relatorio.png" style="height: 147px;"><br>
                                              <a href="#relatorio" aria-controls="relatorio" role="tab" data-toggle="tab" class="link-opcoes-usuario"><strong>Relatórios</strong></a>
                                          </div>
                                      </a>
                                  </div>
                                  <div class="col-md-4 margin-botton-50px">
                                      <a href="pessoa-jurica-admin-planos.php?id=<?php echo $id?>">
                                          <div class="div-admin">
                                              <img src="images/cifrao.png" style="height: 147px;"><br>
                                              <a href="#relatorio" aria-controls="relatorio" role="tab" data-toggle="tab" class="link-opcoes-usuario"><strong>Planos VIP</strong></a>
                                          </div>
                                      </a>
                                  </div>
                                  <div class="col-md-4 margin-botton-50px">
                                      <a href="pessoa-jurica-admin-ajuda.php?id=<?php echo $id?>">
                                          <div class="div-admin">
                                              <img src="images/ajuda.png" style="height: 147px;"><br>
                                              <a href="pessoa-jurica-admin-ajuda.php" class="link-opcoes-usuario"><strong>Ajuda</strong></a>
                                          </div>
                                      </a>
                                  </div>
                              </div>
                        ...
                        <!--incio Planos-->
<!--
                        <div class="row tab-pane fade" id="planos">
                              <div class="text-center">
                                 <h1>Planos</h1>
                                  <div class="col-md-6 margin-botton-50px">
                                      <a href="pessoa-jurica-admin-edita-perfil.php?id=" >
                                          <div class="div-admin">
                                              <img src="images/editar-perfil.jpeg" style="width: 182px;height: 147px;"><br>
                                              <a href="pessoa-jurica-admin-planos-contratados.php"  class="link-opcoes-usuario"><strong>Meus Planos Contratados</strong></a>
                                          </div>
                                      </a>
                                  </div>
                                  <div class="col-md-6 margin-botton-50px">
                                      <a href="reserva-visao-estabelecimento.php?id=">
                                          <div class="div-admin">
                                              <img src="images/solicitacoes-reserva.jpeg" style="width: 182px;height: 147px;"><br>
                                              <a href="reserva-visao-estabelecimento.php"  aria-controls="editar-perfil" role="tab" data-toggle="tab"  class="link-opcoes-usuario"><strong>Contratar novos planos</strong></a>
                                          </div>
                                      </a>                                      
                                  </div>
                              </div>
