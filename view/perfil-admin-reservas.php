                   ...
                   <!--Inicio menu lateral-->
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 tab-content">
                        ...
                        <div class="" id="admin-cadastros">
                             <h1 style="font-size: 30px;">Controle Finaceiro - Controle de Reservas</h1>
                             <div class="row borda-ver-admin">
                                  <div class="margin-bottom-65px">
                                      <form class="form-group" method="POST" action="../controlers/buscaReserva.php?id=9">
                                          <div class="col-md-5">
                                             <select name="atributo" class="form-control">
                                              <option>Selecione</option>
                                              <option value="id_reserva">Id</option>
                                              <option value="nome">Nome Usuário</option>
                                              <option value="dt_reserva">Data</option>
                                              <option value="hr_reserva">Horário</option>
                                              <option value="qtd_pessoa">Qtd_pessoa</option>
                                             </select> 
                                          </div>
                                          <div class="col-md-5">
                                  ...
                                  <?php include "../controlers/retornaReservaADM.php" ?>

                                  <div class="row" style="text-align: right;margin-bottom: 20px;">
                                      <div class="col-md-4"></div>
                                      <div class="col-md-8">
                                          <div class="col-md-4">
                                              <a href="perfil-admin-reservas-alterar.php?id=9&iduser=<?php echo $iduser ?>" class="link-opcoes-usuario">Alterar</a>
                                          </div>
                                          
                                          <div class="col-md-4">
                                              <a href="perfil-admin-reservas-visualizar.php?id=9&iduser=<?php echo $iduser ?>" class="link-opcoes-usuario">Visualizar</a>
                                          </div>
                                          <div class="col-md-4">
