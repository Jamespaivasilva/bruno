                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 tab-content">
                        ...
                        <div class="" id="admin-cadastros">
                             ...
                             <div class="row borda-ver-admin">
                                ...
                                <?php include "../controlers/retornaEmpresaCadastrada.php" ?>

                                  <div class="row" style="text-align: right;margin-bottom: 20px;">
                                      <div class="col-md-4"></div>
                                      <div class="col-md-8">
                                          <div class="col-md-4">
                                              <a href=" <?php echo 'perfil-admin-cadastros-alterar.php?id=9&cod_empresa=' . $cod_empres ?>" class="link-opcoes-usuario">Alterar</a>    
                                          </div>
                                          
                                          <div class="col-md-4">
                                              <a href=" <?php echo 'perfil-admin-cadastros-visualizar.php?id=9&cod_empresa=' . $cod_empres ?>" class="link-opcoes-usuario">Visualizar</a>
                                          </div>
                                          <div class="col-md-4">
                        ...
                        <!--Fim Administração de cadastros-->                 
                    </div>
                </div>
