                        ...
                        <div id="contas-receber">
                             ...
                             <div class="row borda-ver-admin">
                                  <div class="margin-bottom-65px">
                                      <form class="form-group" method="POST" action="../controlers/buscaContasaReceber.php?id=9">
                                          <div class="col-md-5">
                                             <select class="form-control">
                                              <option>Selecione</option>                                              
                                              <option value="num_transicao">N° Transação</option>
                                             </select> 
                                          </div>
                                          <div class="col-md-5">
                                  ...
                                  <table class="table table-bordered">
                                     ...
                                     <?php include "../controlers/retornaTransacoesADM.php";  ?> 
                                  </table>
                                  <div class="row" style="text-align: right;margin-bottom: 20px;">
                                      <div class="col-md-4"></div>
                                      <div class="col-md-8">
                                          <div class="col-md-3">
                                            <!-- "perfil-admin-contas-a-receber-alterar.php" -->
                                              <a href="perfil-admin-contas-a-receber-alterar.php?id=9&tran=<?php echo $tran?>"  class="link-opcoes-usuario">Alterar</a>
                                          </div>
                                          <div class="col-md-3">
                                              <a href="perfil-admin-contas-a-receber-incluir.php?id=9" class="link-opcoes-usuario">Incluir</a>
                                          </div>
                                          <div class="col-md-3">
                                              <a href="perfil-admin-contas-a-receber-visualizar.php?id=9&tran=<?php echo $tran?>"class="link-opcoes-usuario">Visualizar</a>
                                          </div>
                                          <div class="col-md-3">
