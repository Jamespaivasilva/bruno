<?php
  ...
  include '../controlers/dadosTransacao.php';
    ...
    <body>
        ...
        <div class="container main margin-bottom-170px">
            <header>
                ...
                <p><a href=<?php echo 'pessoa-jurica-admin.php?id='. $id ?> class="link-opcoes-usuario"><i class="glyphicon glyphicon-chevron-left"></i>Voltar</a></p>
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 tab-content">
                        ...
                        <div id="inserirAnuncios">
                              <div class="row text-center borda-ver-admin">
                                  ...
                                  <div class="col-xs-12">
                                      <h3 style="text-align: left;margin-bottom: 20px;">Parabéns!!! Sua compra foi finalizada com sucesso!!!</h3>
                                      ...
                                      <div class="col-sm-10" style="text-align: left;margin-bottom: 20px;">
                                          ...
                                          <div class="col-sm-12 col-md-6" style="font-size: 17px;font-weight: bold;margin-bottom: 20px;">
                                              <p><?php echo $cod_autorizacao[0] ?></p>
                                          </div>
                                          <div class="col-sm-12 col-md-6" style="font-size: 14px;font-weight: bold;">
                                              <p>N° Transação(uso interno):</p>
                                          </div>
                                          <div class="col-sm-12 col-md-6" style="font-size: 14px;font-weight: bold;">
                                              <p><?php echo $num_transacao[0] ?></p>
                                          </div>
                                          <div class="col-sm-12 col-md-6" style="font-size: 14px;font-weight: bold;">
                                              <p>Data da Contratação:</p>
                                          </div>
                                          <div class="col-sm-12 col-md-6" style="font-size: 14px;font-weight: bold;">
                                              <p><?php echo $created_at[0] ?></p>
                                          </div>
                                          <div class="col-sm-12 col-md-6" style="font-size: 14px;font-weight: bold;">
                                              <p>Plano:</p>
                                          </div>
                                          <div class="col-sm-12 col-md-6" style="font-size: 14px;font-weight: bold;">
                                              <p><?php echo $plano[0] ?></p>
                                          </div>
                                          <div class="col-sm-12 col-md-6" style="font-size: 14px;font-weight: bold;">
                                              <p>Valor:</p>
                                          </div>
                                          <div class="col-sm-12 col-md-6" style="font-size: 14px;font-weight: bold;">
                                              <p><?php echo $valor[0] ?></p>
                                          </div>
                                          <div class="col-sm-12 col-md-6" style="font-size: 14px;font-weight: bold;">
                                              <p>Validade do Plano:</p>
                                          </div>
                                          <div class="col-sm-12 col-md-6" style="font-size: 14px;font-weight: bold;margin-bottom: 20px;">
                                              <p><?php echo $validade_plano[0] ?></p>
                                          </div>
                                          <p style="text-align: right;"><a href=<?php echo 'pessoa-jurica-admin.php?id='. $id ?> class="link-opcoes-usuario"><i class="glyphicon glyphicon-chevron-left"></i>Voltar</a></p>
                                      </div>
