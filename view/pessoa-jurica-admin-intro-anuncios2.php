                              ...
                              <div class="text-center">
                                 <h1>Anuncios</h1>
                                  <div class="col-md-6 margin-botton-50px">
                                      <a href="pessoa-jurica-admin-anuncios-realizados.php?id=<?php echo $id?>" >
                                          <div class="div-admin">
                                              <img src="images/sucesso.png" style="height: 147px;"><br>
                                              <a href="pessoa-jurica-admin-anuncios-realizados.php?id=<?php echo $id?>"  class="link-opcoes-usuario"><strong>Anuncios</strong></a>
                                          </div>
                                      </a>
                                  </div>
                                  <div class="col-md-6 margin-botton-50px">
                                      <a href="pessoa-jurica-admin-insere-anuncio.php?id=<?php echo $id?>">
                                          <div class="div-admin">
                                              <img src="images/inserir-anucios.jpeg" style="height: 147px;"><br>
                                              <a href="pessoa-jurica-admin-insere-anuncio.php?id=<?php echo $id?>"  aria-controls="editar-perfil" role="tab" data-toggle="tab"  class="link-opcoes-usuario"><strong>Inserir Anuncios</strong></a>
                                          </div>
                                      </a>                                      
                                  </div>
                              </div>
