<?php
    ...
    include "searchfood/controlers/getMoeda.php";
    
    $query = "SELECT imagem, id_anuncio, cod_empresa, valor, titulo FROM anuncio order by clique desc limit 4";
    $sql_query = mysqli_query($conexao, $query) or die ("ERRO DE SERVIDOR [RPC:S:5:AEC-0])");
...
echo "<div class='row margin-botton-50px' style='text-align: -webkit-center; text-align: -moz-center;'>  
            ...
            <div class='col-xs-12 col-sm-6 col-md-3 alinha-centro'>
                    <div class='div-promocoes-hot margin-botton-20px'>
                        ...
                        <a href='searchfood/view/perfil-estabelecimento.php?id=$cod_empresa[$0]&idanuncio=$id[$0]'> <img src='$imagem[0]' class='img-promo img-responsive'></a>                           
                        </div>
                        <div class='link-promo'>
                            <a href='searchfood/view/perfil-estabelecimento.php?id=$cod_empresa[0]&idanuncio=$id[0]'><i class='glyphicon glyphicon-chevron-left'></i>Reserve</a>
                        </div>
                    </div>
                </div>
            ...
            <div class='col-xs-12 col-sm-6 col-md-3 alinha-centro'>
                    <div class='div-promocoes-hot margin-botton-20px'>
                        ...
                        <a href='searchfood/view/perfil-estabelecimento.php?id=$cod_empresa[1]&idanuncio=$id[1]'> <img src='$imagem[1]' class='img-promo img-responsive'></a>                           
                        </div>
                        <div  class='link-promo'>
                            <a href='searchfood/view/perfil-estabelecimento.php?id=$cod_empresa[1]&idanuncio=$id[1]'><i class='glyphicon glyphicon-chevron-left'></i>Reserve</a>
                        </div>
                    </div>
                </div>
            ...
            <div class='col-xs-12 col-sm-6 col-md-3 alinha-centro'>
                    ...
                    <a href='searchfood/view/perfil-estabelecimento.php?id=$cod_empresa[2]&idanuncio=$id[2]'> <img src='$imagem[2]' class='img-promo img-responsive'> </a>                           
                        </div>
                        <div  class='link-promo'>
                            <a href='searchfood/view/perfil-estabelecimento.php?id=$cod_empresa[2]&idanuncio=$id[2]'><i class='glyphicon glyphicon-chevron-left'></i>Reserve</a>
                        </div>
                    </div>
                </div>    
            ...
            <div class='col-xs-12 col-sm-6 col-md-3 alinha-centro'>
                    <div class='div-promocoes-hot margin-botton-20px'>
                        ...
                        <a href='searchfood/view/perfil-estabelecimento.php?id=$cod_empresa[3]&idanuncio=$id[3]'> <img src='$imagem[3]' class='img-promo img-responsive'></a>                           
                        </div>
                        <div  class='link-promo'>
                            <a href='searchfood/view/perfil-estabelecimento.php?id=$cod_empresa[3]&idanuncio=$id[3]'><i class='glyphicon glyphicon-chevron-left'></i>Reserve</a>
                        </div>
                    </div>
                </div>        
    </div>";                     
