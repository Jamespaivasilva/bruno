                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 tab-content">
                        ...
                        <div id="anuncios">
                              <div class="row text-center borda-ver-admin">
                                  <h1 class="margin-botton-50px">Anúncios</h1>
                                  <div class="col-md-6 margin-botton-50px">
                                      <a href="pessoa-jurica-admin-anuncios-realizados.php">
                                          <div class="div-admin">
                                              <img src="images/sucesso.png" style="height: 147px;"><br>
                                              <a href="pessoa-jurica-admin-anuncios-realizados.php" class="link-opcoes-usuario"><strong>Anúncios</strong></a>
                                          </div>
                                      </a>
                                  </div>
                                  <div class="col-md-6 margin-botton-50px">
                                      <a href="pessoa-jurica-admin-insere-anuncio.php">
                                          <div class="div-admin">
                                              <img src="images/inserir-anucios.jpeg" style="height: 147px;"><br>
                                              <a href="pessoa-jurica-admin-insere-anuncio.php"class="link-opcoes-usuario"><strong>Inserir anúncio</strong></a>
                                          </div>
                                      </a>
                                  </div>
                              </div>
