                                  ...
                                  <div class="col-xs-12">
                                      <form class="form-horizontal" method="POST" action="">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              <input type="text" maxlength="10" class="form-control" value="<?php echo $empresa[0] ?>" name="nome-estab" disabled disabled>
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <label class="col-sm-12 control-label padding-top-7px">Valor</label>
                                            <div class="col-sm-6">
                                              <input type="text" class="form-control dinheiro" value="<?php echo $valor[0] ?>" name="valor" disabled>
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <label class="col-sm-12 control-label padding-top-7px">Plano</label>
                                            <div class="col-sm-6">
                                              <input type="text" class="form-control dinheiro" value="<?php echo $plano[0] ?>" name="plano" disabled>
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <label class="col-sm-12 control-label padding-top-7px">Bandeira Cartão</label>
                                            <div class="col-sm-6">
                                              <input type="text" class="form-control dinheiro" value="<?php echo $bandeira[0] ?>" name="bandeira" disabled>
                                            </div>
                                          </div>
                                          <div class="form-group">
